...
This document describes the first version of the graphical server protocol. The core parts of this protocol have been defined and implemented by [Typefox'](http://typefox.io) [Sprotty](https://github.com/theia-ide/sprotty). An implementation of the complete protocol described here can be found in the Sprotty-based prototype of [Eclipse Sirius](https://www.eclipse.org/sirius/) created by [Obeo](https://www.obeo.fr).
